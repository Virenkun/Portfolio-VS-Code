...
const NetworkIcon = (props) => {
  return (
    ...
    >
      ...
      <path className="cls-1" d="M8.46,19.86h0a9.5,9.5,0,1,1,7.1,0h0" />
      <path className="cls-1" d="M15.77,15.33a5.7,5.7,0,1,0-7.54,0" />
      <circle className="cls-1" cx="12" cy="10.1" r="1.9" />
      <path
        className="cls-1"
